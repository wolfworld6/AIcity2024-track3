...
def load_gt_seg_from_json(json_file, split=None, label='label_id', label_offset=0, debug_video_id=None):
    # load json file
...
class ANETdetection(object):
    ...
    def __init__(
        ...
        self.ground_truth = load_gt_seg_from_json(
            ant_file, split=self.split, label=label, label_offset=label_offset, debug_video_id=debug_video_id)
