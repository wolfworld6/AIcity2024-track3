...
def train_one_epoch(
    ...
    for iter_idx, video_list in enumerate(train_loader, 0):
        ...
        # video_list[0].keys:['video_id', 'feats', 'segments', 'labels', 'fps', 'duration', 'feat_stride', 'feat_num_frames']
        # for i, vid in enumerate(video_list):
        #     logger.info("video {} video_id {} feat_stride {} feat_num_frames {} duration {}".format(i, vid['video_id'], vid["feat_stride"], vid['feat_num_frames'], vid['duration'])) 
...
def valid_one_epoch(
    ...
    # if results['t-start']:  # Check if the list is not empty
    ...
    return mAP, avg_mAP, tiou_thresholds
